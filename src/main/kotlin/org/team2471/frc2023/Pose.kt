...
data class Pose(val wristPosition: Vector2, val wristAngle: Angle, val pivotAngle: Angle) {
    companion object {
        ...
        val GROUND_INTAKE_CONE_FAR = Pose(Vector2(40.0, 8.5), 90.0.degrees, 0.0.degrees)
        val GROUND_INTAKE_CUBE_NEAR = Pose(Vector2(18.0, -8.0), 75.0.degrees, -180.0.degrees)
        val GROUND_INTAKE_CUBE_FAR = Pose(Vector2(40.0, -8.0), 75.0.degrees, -180.0.degrees)
        ...
        val BACK_MIDDLE_SCORE_CONE_AWAY = Pose(Vector2(-30.5, 28.5), -180.0.degrees, -180.0.degrees)
        val BACK_MIDDLE_SCORE_CONE_TOWARD_MID = Pose(Vector2(-22.0, 30.5), -100.0.degrees, 0.0.degrees)
        val BACK_MIDDLE_SCORE_CONE_TOWARD = Pose(Vector2(-31.5, 28.0), -100.0.degrees, 0.0.degrees)
        ...
        val BACK_HIGH_SCORE_CONE_TOWARD = Pose(Vector2(-44.0, 39.0), -100.0.degrees, 0.0.degrees)
        val BACK_HIGH_SCORE_CONE_AWAY_MID = Pose(Vector2(-29.0, 45.0), -200.0.degrees, -180.0.degrees)
        val BACK_HIGH_SCORE_CONE_AWAY = Pose(Vector2(-44.0, 43.0), -190.0.degrees, -180.0.degrees)

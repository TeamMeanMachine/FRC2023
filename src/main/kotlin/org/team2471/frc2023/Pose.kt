...
data class Pose(val wristPosition: Vector2, val wristAngle: Angle, val pivotAngle: Angle) {
    companion object {
        ...
        val GROUND_INTAKE_CONE_NEAR = Pose(Vector2(18.0, 11.5), 90.0.degrees, 0.0.degrees)
        val GROUND_INTAKE_CONE_FAR = Pose(Vector2(40.0, 11.5), 90.0.degrees, 0.0.degrees)
...
//        val LOW_SCORE = Pose(Vector2(0.0, 9.0), -90.0.degrees, 180.0.degrees)
        val BACK_MIDDLE_SCORE_CONE_AWAY = Pose(Vector2(-42.0, 26.0), -180.0.degrees, -180.0.degrees)
        val BACK_MIDDLE_SCORE_CONE_TOWARD = Pose(Vector2(-33.0, 27.5), -100.0.degrees, 0.0.degrees)
        ...
        val BACK_HIGH_SCORE_CONE_AWAY = Pose(Vector2(-53.0, 39.0), -200.0.degrees, -180.0.degrees)

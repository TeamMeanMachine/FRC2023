...
data class Pose(val wristPosition: Vector2, val wristAngle: Angle, val pivotAngle: Angle) {
    companion object {
        ...
        val GROUND_INTAKE_FRONT = Pose(Vector2(18.0, 14.0), 90.0.degrees, -90.0.degrees)
        val GROUND_INTAKE_POSE_NEAR = Pose(Vector2(18.0, 10.2), 90.0.degrees, 0.0.degrees)
        val GROUND_INTAKE_POSE_FAR = Pose(Vector2(40.0, 10.2), 90.0.degrees, 0.0.degrees)
...
//        val LOW_SCORE = Pose(Vector2(0.0, 9.0), -90.0.degrees, 180.0.degrees)
        ...
        val BACK_HIGH_SCORE_CONE_AWAY = Pose(Vector2(-53.0, 41.0), -200.0.degrees, -180.0.degrees)

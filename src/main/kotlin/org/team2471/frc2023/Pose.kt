...
//        val LOW_SCORE = Pose(Vector2(0.0, 9.0), -90.0.degrees, 180.0.degrees)
        ...
        val BACK_MIDDLE_SCORE_CONE_AWAY = Pose(Vector2(-33.0, 27.5), -180.0.degrees, -180.0.degrees)
        ...
        val BACK_HIGH_SCORE_CONE_TOWARD_MID = Pose(Vector2(-28.0, 46.0), -100.0.degrees, 0.0.degrees)
        val BACK_HIGH_SCORE_CONE_TOWARD = Pose(Vector2(-44.0, 44.0), -100.0.degrees, 0.0.degrees)

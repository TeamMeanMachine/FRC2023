...
data class Pose(val wristPosition: Vector2, val wristAngle: Angle, val pivotAngle: Angle) {
    companion object {
        ...
        val GROUND_INTAKE_FRONT_CONE = Pose(Vector2(18.0, 14.0), 90.0.degrees, -90.0.degrees)
        val GROUND_INTAKE_FRONT_CUBE = Pose(Vector2(18.0, 14.0), 90.0.degrees, 0.0.degrees)
        val GROUND_INTAKE_CONE_NEAR = Pose(Vector2(18.0, 11.0), 90.0.degrees, 0.0.degrees)
        val GROUND_INTAKE_CONE_FAR = Pose(Vector2(40.0, 11.0), 90.0.degrees, 0.0.degrees)
        val GROUND_INTAKE_CUBE_NEAR = Pose(Vector2(18.0, -4.0), 95.0.degrees, -180.0.degrees)
        val GROUND_INTAKE_CUBE_FAR = Pose(Vector2(40.0, -8.0), 95.0.degrees, -180.0.degrees)
...
//        val LOW_SCORE = Pose(Vector2(0.0, 9.0), -90.0.degrees, 180.0.degrees)
        val BACK_MIDDLE_SCORE_CONE_AWAY = Pose(Vector2(-42.0, 27.0), -180.0.degrees, -180.0.degrees)
        val BACK_MIDDLE_SCORE_CONE_TOWARD = Pose(Vector2(-34.0, 27.5), -100.0.degrees, 0.0.degrees)
        ...
        val BACK_HIGH_SCORE_CONE_AWAY = Pose(Vector2(-53.0, 40.0), -200.0.degrees, -180.0.degrees)
